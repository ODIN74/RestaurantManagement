        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdditionalUserInformation_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitOfMeasurement = table.Column<string>(maxLength: 15, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(maxLength: 100, nullable: false),
                    IsRequiresPreparation = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishesInPreparations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DishesInPreparations_Users_CookId",
                        column: x => x.CookId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DishesInPreparations_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsWeights", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IngredientsWeights_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientsWeights_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalUserInformation_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishesInPreparations_CookId",
                table: "DishesInPreparations",
                column: "CookId");

            migrationBuilder.CreateIndex(
                name: "IX_DishesInPreparations_DishId",
                table: "DishesInPreparations",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientsWeights_DishId",
                table: "IngredientsWeights",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_IngredientsWeights_IngredientId",
                table: "IngredientsWeights",
                column: "IngredientId");
